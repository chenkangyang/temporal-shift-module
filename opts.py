...
parser.add_argument('--tensorrt', '--trt', default=False, action="store_true")
...
parser.add_argument('--deploy', default=False, action="store_true", help='use deploy mode for RepVGG')
parser.add_argument('--soft_shift', default=False, action="store_true", help='use softshift module')
parser.add_argument('--shift_init_mode', default="shift", type=str, help='use softshift module')
